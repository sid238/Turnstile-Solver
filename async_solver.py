...
class AsyncTurnstileSolver:
    ...
    def __init__(self, debug: bool = False, headless: Optional[bool] = True, useragent: Optional[str] = None, browser_type: str = "chromium"):
        self.debug = debug
...
async def get_turnstile_token(url: str, sitekey: str, action: str = None, cdata: str = None, debug: bool = False, headless: bool = True, useragent: str = None, browser_type: str = "chromium"):
